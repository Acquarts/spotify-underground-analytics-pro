...
class GenreAnalyzer:
    ...
    def analyze_genre(self, genre: str) -> Dict:
        ...
        try:
            ...
            print(f"📊 Obteniendo audio features para {len(tracks_list)} tracks...")
            
            # 4. Obtener audio features en lotes pequeños
            ...
            for i in range(0, len(track_ids), self.MAX_AUDIO_FEATURES_PER_REQUEST):
                ...
                try:
                    ...
                    print(f"⚠️ Error obteniendo audio features del lote: {str(e)}")
                    continue
            ...
            if not valid_features:
                ...
                return {
                    ...
                    "avg_popularity": np.mean([t['popularity'] for t in tracks_list]),
                    "note": "Audio features not available - showing basic metrics only",
                    "top_tracks": [
